document.addEventListener("DOMContentLoaded", () => {
  ...
  function addChat(input, product) {
    ...
    userDiv.innerHTML = `<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQHqsJmytpGuazz6EhprAHQsmHyoJCOQPyrIfHfhKcUuA&s" class="avatar"><span>${input}</span>`;
